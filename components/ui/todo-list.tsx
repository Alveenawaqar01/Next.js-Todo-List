...
export default function TodoList() {
  ...
  useEffect(() => {
    ...
    try {
      // Load tasks from local storage safely
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        ...
        <div className="flex items-center mb-4">
          <Input
            ...
            value={newTask}
            onChange={(e: ChangeEvent<HTMLInputElement>) => setNewTask(e.target.value)} // Update new task input
            ...
            aria-label="New task input" // Added aria-label for accessibility
          />
          <Button
            onClick={addTask}
            ...
            >
              <div className="flex items-center">
                ...
                <Checkbox
                  ...
                  aria-label={`Mark task ${task.id} as completed`} // Added aria-label for accessibility
                />
                {editingTaskId === task.id ? (
                  ...
                  <Input
                    ...
                    aria-label={`Edit task ${task.id}`} // Added aria-label for accessibility
                  />
                ) : (
                  // Display task text
                  <span
              ...
              <div className="flex items-center">
                {editingTaskId === task.id ? (
                  ...
                  <Button
                    ...
                    aria-label={`Save task ${task.id} edit`} // Added aria-label for accessibility
                  >
                    Save
                  </Button>
                ) : (
                ...
                <Button
                  ...
                  aria-label={`Delete task ${task.id}`} // Added aria-label for accessibility
                >
                  Delete
                </Button>
              </div>
